...
6. **⚠️ REQUIRED**: Add `DOMAIN` environment variable on RENDER with your deployment domain name __AFTER__ your first deployment and save.  It will be automatically generated by Render (or other host).
...
7. **Get production IPs from Render**
...
4. **Configure MongoDB Atlas production IPs**
   ...
   - "Database & Network" > "IP Access List"
